...
namespace UnityEngine.Events
{
    ...
    public class UnityEvent<T0, T1, T2> : UnityEventBase
    {
        ...
        {
#pragma warning disable UAC2003 // It's not trivial to fix this when TYPES is empty.
...
#pragma warning disable UAC2003 // It's not trivial to fix this when ARGUMENTCOUNT is zero.
