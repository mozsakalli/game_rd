        ...
        public override void Initialize(TimeArea timeArea)
        {
            ...
            if (m_SelectionBoxes == null)
            {
                ...
                for (int i = 0; i < 2; ++i)
                {
                    ...
                    m_SelectionBoxes[i].onStartDrag += (AreaManipulatorBase manipulator, Event evt) =>
                    {
                    ...
                    m_SelectionBoxes[i].onDrag += (AreaManipulatorBase manipulator, Event evt) =>
                    {
                        OnMove(new Vector2(PixelToTime(evt.mousePosition.x, frameRate), 0.0f));
                        return true;
                    };
                    m_SelectionBoxes[i].onEndDrag += (AreaManipulatorBase manipulator, Event evt) =>
                    {
                        OnEndMove();
                        return true;
                    };
