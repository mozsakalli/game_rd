    ...
    internal class CurveEditorRectangleTool : RectangleTool
    {
        ...
        public override void Initialize(TimeArea timeArea)
        {
            ...
            if (m_HBarLeft == null)
            {
                ...
                m_HBarLeft.onStartDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                ...
                m_HBarLeft.onDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnScaleTime(PixelToTime(evt.mousePosition.x, frameRate));
                    return true;
                };
                m_HBarLeft.onEndDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnEndScale();
                    return true;
                };
            ...
            if (m_HBarRight == null)
            {
                ...
                m_HBarRight.onStartDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    if (hasSelection && manipulator.rect.Contains(evt.mousePosition))
                    {
                ...
                m_HBarRight.onDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnScaleTime(PixelToTime(evt.mousePosition.x, frameRate));
                    return true;
                };
                m_HBarRight.onEndDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnEndScale();
                    return true;
                };
            ...
            if (m_HBar == null)
            {
                ...
                m_HBar.onStartDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    if (hasSelection && manipulator.rect.Contains(evt.mousePosition))
                    {
                ...
                m_HBar.onDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnMove(new Vector2(PixelToTime(evt.mousePosition.x, frameRate), 0f));
                    return true;
                };
                m_HBar.onEndDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnEndMove();
                    return true;
                };
            ...
            if (m_VBarBottom == null)
            {
                ...
                m_VBarBottom.onStartDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    if (hasSelection && manipulator.rect.Contains(evt.mousePosition))
                    {
                ...
                m_VBarBottom.onDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnScaleValue(PixelToValue(evt.mousePosition.y));
                    return true;
                };
                m_VBarBottom.onEndDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnEndScale();
                    return true;
                };
            ...
            if (m_VBarTop == null)
            {
                ...
                m_VBarTop.onStartDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    if (hasSelection && manipulator.rect.Contains(evt.mousePosition))
                    {
                ...
                m_VBarTop.onDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnScaleValue(PixelToValue(evt.mousePosition.y));
                    return true;
                };
                m_VBarTop.onEndDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnEndScale();
                    return true;
                };
            ...
            if (m_VBar == null)
            {
                ...
                m_VBar.onStartDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    if (hasSelection && manipulator.rect.Contains(evt.mousePosition))
                    {
                ...
                m_VBar.onDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnMove(new Vector2(0f, PixelToValue(evt.mousePosition.y)));
                    return true;
                };
                m_VBar.onEndDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnEndMove();
                    return true;
                };
            ...
            if (m_SelectionBox == null)
            {
                ...
                m_SelectionBox.onStartDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                ...
                m_SelectionBox.onDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                ...
                m_SelectionBox.onEndDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnEndMove();
                    return true;
                };
            ...
            if (m_SelectionScaleLeft == null)
            {
                ...
                m_SelectionScaleLeft.onStartDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    if (hasSelection && manipulator.rect.Contains(evt.mousePosition))
                    {
                ...
                m_SelectionScaleLeft.onDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnScaleTime(PixelToTime(evt.mousePosition.x, frameRate));
                    return true;
                };
                m_SelectionScaleLeft.onEndDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnEndScale();
                    return true;
                };
            ...
            if (m_SelectionScaleRight == null)
            {
                ...
                m_SelectionScaleRight.onStartDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    if (hasSelection && manipulator.rect.Contains(evt.mousePosition))
                    {
                ...
                m_SelectionScaleRight.onDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnScaleTime(PixelToTime(evt.mousePosition.x, frameRate));
                    return true;
                };
                m_SelectionScaleRight.onEndDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnEndScale();
                    return true;
                };
            ...
            if (m_SelectionRippleLeft == null)
            {
                ...
                m_SelectionRippleLeft.onStartDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    if (hasSelection && manipulator.rect.Contains(evt.mousePosition))
                    {
                ...
                m_SelectionRippleLeft.onDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnScaleTime(PixelToTime(evt.mousePosition.x, frameRate));
                    return true;
                };
                m_SelectionRippleLeft.onEndDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnEndScale();
                    return true;
                };
            ...
            if (m_SelectionRippleRight == null)
            {
                ...
                m_SelectionRippleRight.onStartDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    if (hasSelection && manipulator.rect.Contains(evt.mousePosition))
                    {
                ...
                m_SelectionRippleRight.onDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnScaleTime(PixelToTime(evt.mousePosition.x, frameRate));
                    return true;
                };
                m_SelectionRippleRight.onEndDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnEndScale();
                    return true;
                };
            ...
            if (m_SelectionScaleBottom == null)
            {
                ...
                m_SelectionScaleBottom.onStartDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    if (hasSelection && manipulator.rect.Contains(evt.mousePosition))
                    {
                        OnStartScale(ToolCoord.Top, ToolCoord.Bottom, new Vector2(0f, PixelToValue(evt.mousePosition.y)), DragMode.ScaleVertical, false);
                ...
                m_SelectionScaleBottom.onDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnScaleValue(PixelToValue(evt.mousePosition.y));
                    return true;
                };
                m_SelectionScaleBottom.onEndDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnEndScale();
                    return true;
                };
            ...
            if (m_SelectionScaleTop == null)
            {
                ...
                m_SelectionScaleTop.onStartDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    if (hasSelection && manipulator.rect.Contains(evt.mousePosition))
                    {
                        OnStartScale(ToolCoord.Bottom, ToolCoord.Top, new Vector2(0f, PixelToValue(evt.mousePosition.y)), DragMode.ScaleVertical, false);
                ...
                m_SelectionScaleTop.onDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnScaleValue(PixelToValue(evt.mousePosition.y));
                    return true;
                };
                m_SelectionScaleTop.onEndDrag += (AreaManipulatorBase manipulator, Event evt) =>
                {
                    OnEndScale();
                    return true;
                };
